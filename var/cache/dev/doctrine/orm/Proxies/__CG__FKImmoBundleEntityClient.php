 ...
 */
class Client extends \FK\ImmoBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FK\\ImmoBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'FK\\ImmoBundle\\Entity\\Client' . "\0" . 'numeropiece', '' . "\0" . 'FK\\ImmoBundle\\Entity\\Client' . "\0" . 'nomcomplet', '' . "\0" . 'FK\\ImmoBundle\\Entity\\Client' . "\0" . 'login', '' . "\0" . 'FK\\ImmoBundle\\Entity\\Client' . "\0" . 'email', '' . "\0" . 'FK\\ImmoBundle\\Entity\\Client' . "\0" . 'adresse', '' . "\0" . 'FK\\ImmoBundle\\Entity\\Client' . "\0" . 'phone', '' . "\0" . 'FK\\ImmoBundle\\Entity\\Client' . "\0" . 'password', '' . "\0" . 'FK\\ImmoBundle\\Entity\\Client' . "\0" . 'contrats', '' . "\0" . 'FK\\ImmoBundle\\Entity\\Client' . "\0" . 'reservations'];
        }
