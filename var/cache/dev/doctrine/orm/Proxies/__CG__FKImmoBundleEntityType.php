 ...
 */
class Type extends \FK\ImmoBundle\Entity\Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FK\\ImmoBundle\\Entity\\Type' . "\0" . 'id', '' . "\0" . 'FK\\ImmoBundle\\Entity\\Type' . "\0" . 'nomtype', '' . "\0" . 'FK\\ImmoBundle\\Entity\\Type' . "\0" . 'biens'];
        }
